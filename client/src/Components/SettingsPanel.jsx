...
export default function SettingsPanel() {
  ...
  return (
    <div
      ...
      ref={panelRef}
    >
      <div className="z-40 settings-menu w-0 h-full group-hover/main:w-80 group-hover/main:p-4 duration-1000 bg-blue-500 text-nowrap border rounded overflow-hidden">
        {/* Accent Color */}
      ...
      {/* Settings Icon */}
      <div
        className={`settings-icon bg-yellow-200 flex items-center justify-end w-20 h-20 p-4 border rounded z-30`}
      >
